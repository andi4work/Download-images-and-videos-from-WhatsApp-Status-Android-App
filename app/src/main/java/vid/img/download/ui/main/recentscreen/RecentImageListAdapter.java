...
public class RecentImageListAdapter extends RecyclerView.Adapter<RecentImageListAdapter.ImageListViewHolder> {
    ...
    public void showSaveProgress(View itemView) {
        ...
        TextView saveImageView = (TextView) itemView.findViewById(R.id.save_image_view);
    ...
    public void showDeleteButton(View itemView) {
        ProgressBar progressBarForSave = (ProgressBar) itemView.findViewById(R.id.progress_bar_for_save);
        TextView deleteImageView = (TextView) itemView.findViewById(R.id.delete_image_view);
    ...
    class ImageListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageListViewHolder(View itemView) {
            ...
            saveImageView = itemView.findViewById(R.id.save_image_view);
            deleteImageView = itemView.findViewById(R.id.delete_image_view);
            progressBarForSave = itemView.findViewById(R.id.progress_bar_for_save);
            playImageView = itemView.findViewById(R.id.play_image_view);
